                            ...
                            <div class="relative pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                                <div>
                                    <div class="flex justify-between">
                                        <h3 class="text-sm">
                                            <a :href="product.href"
                                                class="font-medium text-gray-700 hover:text-gray-800">Escoba magica</a>
                                        </h3>
                                    </div>
                                    ...
                                    <p class="mt-1 text-sm font-medium text-gray-900">111.22</p>
                                </div>

                                <div class="mt-4 sm:mt-0 sm:pr-9">
                                    <label :for="" class="sr-only">Quantity,</label>
                                    <select :id="" :name="`quantity-${productIdx}`"
            ...
            <section aria-labelledby="summary-heading"
                ...
                <div class="mt-6">
                    <a href="{{route('cart.method')}}"
                        class="w-full text-center rounded-md border border-transparent bg-indigo-600 py-3 px-4 text-base font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-50"">Checkout</a>
                </div>
            </section>
        </form>
    </div>
