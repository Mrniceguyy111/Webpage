...
<main>
    ...
    -->
                                ...
                                <div class="showcase-container">
                                    <div class="showcase">
                                        <a href="#" class="showcase-img-box">
                                            <img src="{{asset('images/logo.png')}}" alt="more_sell" width="75"
        ...
        <div id="promotion-bar" style="background-image: url({{ asset('images/others/abstract.png') }})"
            class="p-6 py-12" bis_skin_checked="1">
            ...
            <div class="container">
                ...
                <div class="category-item-container has-scrollbar">
                    ...
                    <div class="category-item flex flex-col text-center">
                        ...
                        <div class="category-content-box ">
                            <a href="#" class="category-btn">Conejos</a>
                        </div>
                    </div>
                    <div class="category-item flex flex-col text-center">
                        <div class="category-img-box">
                        ...
                        <div class="category-content-box ">
                            <a href="#" class="category-btn">Aves</a>
                        </div>
                    </div>

                    <div class="category-item flex flex-col text-center">
                        <div class="category-img-box">
                            <img src="{{asset('images/animals/Hedgehogs_Hamsters.png')}}" alt="dress & frock"
                                width="150">
                        </div>
                        <div class="category-content-box ">
                            <a href="#" class="category-btn">Hamsters y Erizos</a>
                        </div>
                    </div>
                    ...
                    <div class="category-item flex flex-col text-center">
                        ...
                        <div class="category-content-box ">
                            <a href="#" class="category-btn">Vacas</a>
                        </div>
                    </div>
                    <div class="category-item flex flex-col text-center">
                        <div class="category-img-box">
                        ...
                        <div class="category-content-box ">
                            <a href="#" class="category-btn">Cabras</a>
                        </div>
                    </div>
        ...
        <h2 class="mt-6 text-center text-2xl tracki font-bold" style="color: #2b1411;">¡Nuestros productos del momento!
        </h2>
        <div class="carrusel">
        ...
        <div>
                    ...
                    <div class="testimonial">
                        ...
                        <div class="testimonial-card">
                            <div class="testimonial-imgs">
                                <img src="{{asset('images/profile/JR.png')}}" alt="" class="testimonial-banner"
                                    width="70" height="70">
                                <img src="{{asset('images/profile/LN.jpg')}}" alt="" class="testimonial-banner"
                                    width="70" height="70">
                            </div>
                            <p class="testimonial-name">Julian Ramirez</p>
                            <p class="testimonial-title">Backend Developer de Hatchi</p>
                            <img src="{{asset('images/testimonia.png')}}" alt="quotation" class="quotation-img"
                                width="26">
                            <p class="testimonial-desc">
                                Elaborar hatchi, no es solo un trabajo, fue encaminar y reforzar mi amor por los
                                animales, aprendi y
                                considere que porfin se creo una linea 100% petfriendly para nuestros amiguitos que no
                                hablan.
                            </p>
                        </div>
                    </div>
          ...
          -->
                    <div class="cta-container">
                        <video autoplay loop muted playsinline src="{{asset('videos/CtaLetras.mp4')}}"
                            class="cta-banner">
                            {{--
                        ...
                        <div class="service-container">
                            ...
                            <a href="#" class="service-item">
                                ...
                                <div class="service-content">
                                    ...
                                    <p class="service-desc">Envios el mismo dia, compra en linea y recoje en tienda o
                                        usando nuestro nuevo
                                        sistema de autoship.
                                    </p>
                            ...
                            <a href="#" class="service-item">
                                ...
                                <div class="service-content">
                                    ...
                                    <p class="service-desc">Cuidamos tanto tus mascotas, que realizamos todo tipo de
                                        asesoriamiento y
    ...
    -->
        <div class="blog">
            ...
            'post' => $item->slug
                            ...
                            <img src="{{asset('storage/blogs/'.$item->banner_image)}}" alt="{{$item->image}}"
