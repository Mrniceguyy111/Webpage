                                ...
                                <tr>
                                    <td align="center" valign="top">
                                        <a href="#" target="_blank" style="text-decoration: none"><img
                                                src="{{asset('images/logo.png')}}" width="150" height="150"
                                                alt="Logo Hatchi" border="0" style="
                                                        display: block;
                                                        font-family: Arial,
                                                            sans-serif;
                                                        font-size: 18px;
        ...
        <tr>
            <td align="center" valign="top" class="em_aside5">
                <table align="center" width="650" border="0" cellspacing="0" cellpadding="0" class="em_main_table"
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                                ...
                                <tr>
                                    {{-- <td valign="top" align="center">
                                        <img src="/assets/pilot/images/templates/cat_1.jpg" width="380" height="200"
                                            class="em_full_img2" alt="Alt tag goes here" border="0" style="
                                                    display: block;
                                                    max-width: 380px;
                                                    font-family: Arial,
                                                        sans-serif;
                                ...
                                <tr>
                                    <td class="em_grey" align="center" valign="top" style="
                                        ...
                                        experiencia posible, tanto en la selección de sus mascotas como en el cuidado de
                                        las mismas. Por eso, estamos trabajando duro para ofrecerte toda la información
                                        que necesitas para tomar una decisión informada. <br><br>

                                        En los próximos días, te enviaremos más información sobre nuestra tienda,
                                        nuestros productos y servicios. Mientras tanto, puedes visitar nuestra página
                    ...
                    <tr>
                        <td height="15" class="em_h10" style="
                                    height: 15px;
                                    font-size: 1px;
                                    line-height: 1px;
                                ">
        ...
        <tr>
            <td align="center" valign="top">
                <table align="center" width="650" border="0" cellspacing="0" cellpadding="0" class="em_main_table"
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                                            ...
                                            <tr>
                                                <td width="30" style="width: 30px" align="center" valign="middle">
                                                    <a href="#" target="_blank" style="
                                                            ...
                                                            "><img src="/assets/pilot/images/templates/fb.png"
                                                            width="30" height="30" alt="Fb" border="0" style="
                                                                    display: block;
                                                                    font-family: Arial,
                                                                        sans-serif;
                                                                    font-size: 18px;
                                                ...
                                                <td width="30" style="width: 30px" align="center" valign="middle">
                                                    <a href="#" target="_blank" style="
                                                                text-decoration: none;
                                                            "><img src="/assets/pilot/images/templates/tw.png"
                                                            width="30" height="30" alt="Tw" border="0" style="
                                                                    display: block;
                                                                    font-family: Arial,
                                                                        sans-serif;
                                                                    font-size: 14px;
                                                ...
                                                <td width="30" style="width: 30px" align="center" valign="middle">
                                                    <a href="#" target="_blank" style="
                                                                text-decoration: none;
                                                            "><img src="/assets/pilot/images/templates/insta.png"
                                                            width="30" height="30" alt="Insta" border="0" style="
                                                                    display: block;
                                                                    font-family: Arial,
                                                                        sans-serif;
                                                                    font-size: 14px;
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0" align="center">
                                            <tr>
                                                <td width="15" align="left" valign="middle" style="
                                                            ...
                                                            width: 15px;
                                                        ">
                                                    <a href="mailto:meow@meowgun.com" style="
                                                                text-decoration: none;
                                                            "><img src="/assets/pilot/images/templates/email_img.png"
                                                            width="15" height="12" alt="" border="0" style="
                                                                    display: block;
                                                                    max-width: 15px;
                                                                " /></a>
                                                </td>
                                                <td width="9" style="
                                                            ...
                                                            line-height: 0px;
                                                        " class="em_w5">
                                                    <img src="/assets/pilot/images/templates/spacer.gif" width="1"
                                                        height="1" alt="" border="0" style="
                                                                display: block;
                                                            " />
                                                </td>
                                                <td class="em_grey em_font_11" align="left" valign="middle" style="
                                                    ...
                                                    <a href="mailto:meow@meowgun.com" style="
                                                                ...
                                                                color: #434343;
                                                            ">meow@meowgun.com</a>
                                                    <a href="mailto:marketing@mailgun.com" style="
                                                                text-decoration: none;
                                                                color: #434343;
                                ...
                                <tr>
                                    <td align="center" valign="top">
                                        <table border="0" cellspacing="0" cellpadding="0" align="center">
                                            <tr>
                                                <td width="12" align="left" valign="middle" style="
                                                            font-size: 0px;
                                                            line-height: 0px;
                                                            width: 12px;
                                                        ">
                                                    <a href="#" target="_blank" style="
                                                                text-decoration: none;
                                                            "><img src="/assets/pilot/images/templates/img_1.png"
                                                            width="12" height="16" alt="" border="0" style="
                                                                    display: block;
                                                                    max-width: 12px;
                                                                " /></a>
                                                </td>
                    ...
                    <tr>
                        <td height="1" bgcolor="#dadada" style="
                                    font-size: 0px;
                                    line-height: 0px;
                                    height: 1px;
                                ">
                            <img src="/assets/pilot/images/templates/spacer.gif" width="1" height="1" alt="" border="0"
                                style="display: block" />
                        </td>
                    </tr>
                    <tr>
                                ...
                                <tr>
                                    <td align="center" valign="top">
                                        <table border="0" cellspacing="0" cellpadding="0" align="left"
                                            class="em_wrapper">
                                            <tr>
                                                <td class="em_grey" align="center" valign="middle" style="
                                                            font-family: Arial,
                                                                sans-serif;
                                                            font-size: 11px;
                                                            line-height: 16px;
                    ...
                    <tr>
                        <td class="em_hide" style="
                                ...
                                ">
                            <img alt="" src="/assets/pilot/images/templates/spacer.gif" height="1" width="650" style="
                                        max-height: 1px;
                                        min-height: 1px;
                                        display: block;
                                        width: 650px;
