...
<div class="bg-white">
    ...
    <div class="mx-auto max-w-2xl px-4 pt-16 pb-24 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        <h1 wire:click='test' class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Carrito de compras
        </h1>
                        ...
                        <div class="ml-4 flex flex-1 flex-col justify-between sm:ml-6">
                            <div class="relative pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                                ...
                                <div class="mt-4 sm:mt-0 sm:pr-9">
                                    ...
                                    <select wire:model=' qty' :id="" :name="`quantity-{{$item->qty}}`"
            ...
            <section aria-labelledby="summary-heading"
                ...
                {{-- <div class="mt-6">
                    <a href="{{route('cart.method')}}"
                        class="w-full text-center rounded-md border border-transparent bg-principal py-3 px-4 text-base font-medium text-white shadow-sm hover:bg-principal focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-50"">Checkout</a>
                </div> --}}
            </section>
        </form>
        {{-- @else --}}
        <h1 class=" text-center text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">¡No hay objetos en el
                        carro!</h1>
