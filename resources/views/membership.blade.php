...
<section class="text-gray-700 body-font overflow-hidden">
    <div class="container px-5 py-24 mx-auto">
        <div class="flex flex-col text-center w-full mb-20">
            <h1 class="sm:text-4xl text-3xl font-medium title-font mb-2 text-gray-900">Membresias</h1>
            <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Lorem ipsum dolor sit, amet consectetur adipisicing
                elit. Molestiae consequatur pariatur rem.</p>
            <div class="flex mx-auto border-2 border-indigo-500 rounded overflow-hidden mt-6">
                <button class="button-mensual py-1 px-4 bg-indigo-500 text-white focus:outline-none ">Mensual</button>
                <button class="py-1 px-4 focus:outline-none button-anual">Anual</button>
            </div>
        </div>
        ...
        <div class="flex flex-wrap -m-4 anual-targets hidden">
            <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
                <div class="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
                    <img src="{{asset('images/logo.png')}}" alt="" width="50px">
                    <h2 class="text-sm tracking-widest title-font mb-1 font-medium">Inicioxd</h2>
                    <h1 class="text-5xl text-gray-900 pb-4 mb-4 border-b border-gray-200 leading-none">Gratis</h1>
                    <p class="flex items-center text-gray-600 mb-2">
                        <span
                            class="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-500 text-white rounded-full flex-shrink-0">
