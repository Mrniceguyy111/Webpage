    ...
    <footer>
            ...
            <div class="container">
                ...
                <div class="footer-bottom">
                    <div class="dowloand-zone">
                        <img src="{{asset('images/others/svg/AppleBadge.svg')}}" alt="disponible app"
                            class="dowloand-img">
                        <img src="{{asset('images/others/googlePlayBadge.png')}}" alt="disponible app"
                            class="dowloand-img">
                        <img src="{{asset('images/others/appGalleryBadge.png')}}" alt="disponible app"
                            class="dowloand-img">
                    </div>
                </div>
            </div>
        ...
        <div class="footer-bottom">
            <div class="payment-zone">
                <img src="{{asset('images/others/pse.png')}}" alt="payment method" class="payment-img2pse">
